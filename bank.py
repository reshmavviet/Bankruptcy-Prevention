...
# Load the model
load_file = open('model_poly.pkl', 'rb')
...
def main():
    ...
    def add_bg_from_url(url):
        st.markdown(
            f"""
             <style>
             .stApp {{
                 background-image: url('{"https://www.famousquotes123.com/gifs/quotes_images/385784.jpg"}');
    ...
    add_bg_from_url("https://www.famousquotes123.com/gifs/quotes_images/385784.jpg")
